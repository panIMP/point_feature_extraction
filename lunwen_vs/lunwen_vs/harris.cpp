...
void guassin(Int32 *inPtr, Int32 *outPtr, Int16 width, Int16 height)
{
	Int32 i;
	Int32 affectSize = width * (height - 2) - 2;
	Int32 width2 = width * 2;
	...
	for (i = 0; i < affectSize; ++i)
	{
		...
		// Store it.
		outPtr[i + width + 1] = sum >> 4;
	}
}


Uint32 harris(Int32 *img_Ix, Int32 *img_Iy, Int32 *img_Ixy,
	Uint8 *img_Mark, Int16 width, Int16 height,
	Uint32 tarPointNum)
{
	// Memory allcation
	Int32 i;
	...
	Int64 Ix00, Ix01, Ix02;
	Int64 Ix10, Ix11, Ix12;
	Int64 Ix20, Ix21, Ix22;

	Int64 Iy00, Iy01, Iy02;
	Int64 Iy10, Iy11, Iy12;
	Int64 Iy20, Iy21, Iy22;
	...
	for (i = startPoint; i < endPoint; ++i) {
		...
		Ixy = img_Ixy[i];
		cim = (Ix11 * Ix11 * Iy11 * Iy11 - Ixy * Ixy) / (I + 1);
